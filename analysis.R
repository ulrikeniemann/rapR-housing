...
esch_plot
# Mamer
mamer_plot <- make_plot(country_level_data, commune_level_data, communes[3])
# Schengen 
schengen_plot <- make_plot(country_level_data, commune_level_data, communes[4])
# Wincrange
wincrange_plot <- make_plot(country_level_data, commune_level_data, communes[5])
